...
<body>
    <!-- statr Nav  -->
    <nav class="navbar navbar-expand-lg navbar-light py-0 custom-nav">
        <div class="container-fluid px-0">
            <a class="navbar-brand m-auto py-0" href="#">
                <img src="images/AgroMap-top-logo.png" alt="" style="width: 260px; height:51px;">
            </a>
    ...
    <!-- statr Nav form -->
    <nav class="navbar navbar-expand-lg navbar-light py-0 custom-form" style="background-color: #2D2D2D;">
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <div id="filterPanel" style="padding: 10px 5px;">
